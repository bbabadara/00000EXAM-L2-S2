...
public function findByDetteId($id){
    $sql="SELECT *,(qte*prixAchat) sousTotal,SUM((qte*prixAchat)) prixTotal from article a join artdette ad on a.idart=ad.idArticle join dette d on ad.idDette=d.iddet WHERE d.iddet=$id GROUP BY a.idart ";
    return parent::doSelect($sql);
}
